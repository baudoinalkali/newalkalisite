    ...
    <div className="bg-alkaligrey-200 px-7">
      ...
      <div className="pt-24 flex text-center justify-center z-20">
        <div className="relative z-20">
          ...
          <h1 className="text-alkaligrey-800 font-bold py-5 text-7xl max-w-6xl">Ehancing Your Online Presence Made Easy</h1>
          <p className="text-white text-alkaligrey-800 max-w-2xl m-auto pb-10">Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum </p>
        </div>
      </div>

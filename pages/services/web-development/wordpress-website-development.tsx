...
function WordPressWebsiteDevelopment() {
    ...
    return <div className="m-auto overflow-hidden">
            ...
            <div className="py-24 px-0 lg:px-14">
                <div className="flex flex-col space-x-0 lg:space-x-14 lg:flex-row m-auto justify-between items-center max-w-7xl">
                    <div className="px-10 w-full lg:w-1/2 2xl:px-0 pb-20 lg:pb-0">
                        <h2 className="text-3xl md:text-4xl font-bold m-auto leading-tight">WordPress Website Development</h2>
        ...
        <div className="py-24 pt-0 bg-alkaligrey-300 px-10 2xl:px-0">
            <div className="flex flex-col space-x-0 lg:space-x-14 lg:flex-row m-auto justify-between max-w-7xl">
                <div className="w-full lg:w-1/2">
                    <h3 className="text-3xl md:text-4xl font-bold m-auto leading-tight pt-7">Advantages:</h3>
                ...
                <div className="w-full lg:w-1/2">
                    <h3 className="text-3xl md:text-4xl font-bold m-auto leading-tight pt-7">Disadvantages:</h3>
        ...
        <div className="pt-24 px-10 2xl:px-0">
            <h2 className="text-3xl md:text-4xl pb-7 text-center font-bold m-auto leading-tight">Not All Websites Are Created Equal</h2>
        ...
        <div className="-mt-72 px-10 2xl:px-0">
            <h2 className="text-3xl md:text-4xl text-center font-bold m-auto leading-tight pb-14">Hear It Straight From Our Clients</h2>
        </div>
        ...
        <div className="py-24 px-14 2xl:px-0 bg-white">
            <h2 className="text-3xl md:text-4xl pb-7 text-center font-bold m-auto leading-tight">Integration Is the Name of the Game</h2>
            <p className="text-center max-w-4xl m-auto text-lg font-normal pt-4">
        ...
        <div className="py-24 max-w-7xl m-auto">
            <h2 className="text-3xl md:text-4xl pb-7 text-center font-bold m-auto leading-tight">Frequently Asked Questions About Our WordPress Development</h2>

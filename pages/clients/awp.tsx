  ...
  return (
    <div className="m-auto overflow-hidden">
      <Head>
        ...
        <meta property="og:description" content="Learn more about how we completely redesigned Aerial Work Platform's digital presence to fit their business's needs better." />
      ...
      <section className="bg-alkaligrey-300 pt-96 -mt-96">
        ...
        <div className="flex items-center justify-center group space-x-3">
          <a href="/clients" className="font-medium text-alkaligrey-900">View All Projects</a>

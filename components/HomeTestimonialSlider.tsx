          ...
          <div key={idx} className="px-4 pb-20 duration-500">
            ...
            >
              <div className="p-10 py-7 bg-white group-hover:bg-opacity-0 duration-500">
                ...
                <div
                  className="justify-center p-4 px-6 w-48 m-auto font-medium text-white hover:bg-white hover:bg-opacity-20 rounded-md transition duration-500 ease-in-out border border-white hidden group-hover:flex"
                  style={{ marginTop: "1.8rem", marginBottom: "1.8rem" }}
                >
                  View Project
                </div>
              </div>
              <div className="flex px-10 py-7 items-center gap-x-10 rounded-b-md">
                <div className="h-10">

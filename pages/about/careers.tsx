        ...
        <div className="py-20 flex text-center justify-center z-20">
          <div className="relative z-20">
            ...
            <p className="text-white py-10 text-alkaligrey-800 max-w-2xl m-auto text-xl lg:text-2xl">
              If you're looking for your next adventure, check out our open
              positions below.
            </p>
          </div>
        </div>
        ...
        <div className="border-b pb-14 mb-14">
          <div className="flex justify-between">
            <div>
              ...
              <div className="text-lg font-bold pt-4 uppercase">Remote</div>
            </div>
          ...
          <div className="pt-8">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut mi urna,
            consectetur sit amet urna eget, blandit vestibulum mi. Vivamus
            hendrerit dapibus sapien ac hendrerit. Aenean consequat ultrices
            libero id rutrum. Suspendisse interdum justo at sollicitudin
            rhoncus. Orci varius natoque penatibus et magnis dis parturient
            montes, nascetur ridiculus mus. Vestibulum rhoncus luctus tellus a
            tristique. Aenean hendrerit sapien et hendrerit laoreet. Etiam
            convallis pharetra risus, eget accumsan est congue nec. In porta
            ipsum vitae euismod sodales. Fusce volutpat scelerisque odio eu
            aliquet.
          </div>
        </div>
        <div className="border-b pb-14 mb-14">

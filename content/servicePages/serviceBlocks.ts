import ServiceResultsContent from "./resultsBlock"

const ServiceBlocksContent = {
    localSEO: [
        {
...
const LocalSEOServices = ServiceBlocksContent.localSEO
const SEOServices = ServiceBlocksContent.SEO
const EcommerceServices = ServiceBlocksContent.Ecommerce

...
function Carro() {
    const carroGoalImage = GoCottageContent.goCottage.section1.map(goCottage =>
        <StandardImage
            imageAngle="left"
    ...
    const carroResultImage = GoCottageContent.goCottage.section2.map(goCottage =>
        <StandardImage
            imageAngle="right"
            image={goCottage.image}
    ...
    const carroResultText = GoCottageContent.goCottage.section2.map(goCottage =>
        <StandardTextBlock
            sub={goCottage.sub}
            title={goCottage.title}
            text={goCottage.text}

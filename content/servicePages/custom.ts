const Custom = {
    ...
    customBuilt: [
        {
            ...
            image: "/images/web-development/custom/scale-flexibility.svg",
            altText: "Built with scale and flexibility in mind",
            width: "675",
            height: "450"  
        },
    ],
    responsiveDesign: [
        {
            title: "Integrate With Endless CMSs",
            ...
            image: "/images/web-development/custom/integrate-cms.svg",
            altText: "Integrate your custom solution with endless CMSs",
            width: "600",
            height: "400"  
        },
    ],
    seo: [
        {
            ...
            image: "/images/web-development/custom/complete-control.svg",
            altText: "Complete control",
            width: "600",
            height: "400"  
        },
    ],
    userExperience: [
        {
            ...
            image: "/images/web-development/custom/unmatched-performance.svg",
    ...
    performance: [
        {
            ...
            image: "/images/web-development/performance.png",
            altText: "",
            width: "600",
            height: "400"  
        },
    ...
    conversion: [
        {
            ...
            image: "/images/web-development/conversion.png",
            altText: "",
            width: "600",
            height: "400"  
        },
